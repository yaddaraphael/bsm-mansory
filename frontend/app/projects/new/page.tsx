...
export default function NewProjectPage() {
            ...
            <main className="flex-1 p-4 md:p-6 bg-gray-50 overflow-y-auto pt-16 md:pt-20">
              <Card>
                <div className="text-center py-8">
                  <p className="text-red-600">You don&apos;t have permission to create projects.</p>
                </div>
              </Card>
            </main>
          </div>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errData = err as { response?: { data?: { branch?: string[] } } };
      setError(
        error.response?.data?.detail || 
        error.response?.data?.name?.[0] ||
        errData.response?.data?.branch?.[0] ||
        ...
        <div className="flex-1 flex flex-col min-w-0 sidebar-content">
          ...
          <main className="flex-1 p-4 md:p-6 bg-gray-50 overflow-y-auto pt-16 md:pt-20">
            <div className="mb-4 md:mb-6">
              ...
              <h1 className="text-xl md:text-2xl font-bold text-gray-900">Create New Project</h1>
            </div>
                    ...
                    <div>
                      ...
                      {branches.length === 0 && !branchesLoading && (
                        <p className="text-xs text-gray-500 mt-1">
                          No branches available. <button type="button" onClick={() => router.push('/branches/new')} className="text-primary hover:underline">Create one first</button>.
                        </p>
                      )}
                    </div>
                ...
                <Card title="Assignments">
                  <div className="space-y-4">
                    <div>
                      ...
                      <Input
                        type="text"
                        value={searchTerms.project_manager}
                        onChange={(e) => setSearchTerms({ ...searchTerms, project_manager: e.target.value })}
                      ...
                      >
                        ...
                        {filterUsers(projectManagers, searchTerms.project_manager).map((pm) => (
                    ...
                    <div>
                      ...
                      <Input
                        type="text"
                        value={searchTerms.superintendent}
                        onChange={(e) => setSearchTerms({ ...searchTerms, superintendent: e.target.value })}
                      ...
                      >
                        ...
                        {filterUsers(superintendents, searchTerms.superintendent).map((superintendent) => (
                    ...
                    <div>
                      ...
                      <Input
                        type="text"
                        value={searchTerms.general_contractor}
                        onChange={(e) => setSearchTerms({ ...searchTerms, general_contractor: e.target.value })}
                      ...
                      >
                        ...
                        {filterUsers(generalContractors, searchTerms.general_contractor).map((gc) => (
                    ...
                    <div>
                      ...
                      <Input
                        type="text"
                        value={searchTerms.foreman}
                        onChange={(e) => setSearchTerms({ ...searchTerms, foreman: e.target.value })}
                      ...
                      >
                        ...
                        {filterUsers(foremen, searchTerms.foreman).map((foreman) => (
                ...
                {success && (
                  <Card>
                    <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded">
                      ...
                      <p className="text-sm mt-1">Job number will be auto-generated. Redirecting to projects list...</p>
                    </div>
                  </Card>
                )}
